#!/bin/bash
#SBATCH --job-name=GTStoSST # nombre para identificar el trabajo. Por defecto es el nombre del script
...
#SBATCH --time=15-0 # tiempo máximo de ejecución, el formato es: dias-horas / dias-horas:minutos / horas:minutos:segundos

# aqui comienzan los comandos
# code_saturne run --param setup.xml
mpirun -np 60 ./run_solver
