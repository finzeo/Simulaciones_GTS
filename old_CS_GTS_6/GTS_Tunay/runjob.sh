#!/bin/bash
#SBATCH --job-name=GTS_Tunay # nombre para identificar el trabajo. Por defecto es el nombre del script
#SBATCH --ntasks=8 # cantidad de cores pedidos
#SBATCH --ntasks-per-node=2 # cantidad de cores por nodo, para que agrupe o distribuya procesos
...
#SBATCH --time=0-20 # tiempo máximo de ejecución, el formato es: dias-horas / dias-horas:minutos / horas:minutos:segundos

# aqui comienzan los comandos
code_saturne run --param hello.xml
