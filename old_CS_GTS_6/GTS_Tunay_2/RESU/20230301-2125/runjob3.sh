#!/bin/bash
#SBATCH --job-name=c28_4fwallfunc # nombre para identificar el trabajo. Por defecto es el nombre del script
...
#SBATCH --time=7-0 # tiempo máximo de ejecución, el formato es: dias-horas / dias-horas:minutos / horas:minutos:segundos
