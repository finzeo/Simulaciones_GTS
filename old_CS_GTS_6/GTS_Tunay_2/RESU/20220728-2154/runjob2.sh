#!/bin/bash
#SBATCH --job-name=GTS_02 # nombre para identificar el trabajo. Por defecto es el nombre del script
#SBATCH --ntasks=4 # cantidad de cores pedidos
#SBATCH --ntasks-per-node=1 # cantidad de cores por nodo, para que agrupe o distribuya procesos
