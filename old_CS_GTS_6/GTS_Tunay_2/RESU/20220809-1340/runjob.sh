#!/bin/bash
#SBATCH --job-name=GTS_25ms_velautom # nombre para identificar el trabajo. Por defecto es el nombre del script
...
#SBATCH --time=5-0 # tiempo máximo de ejecución, el formato es: dias-horas / dias-horas:minutos / horas:minutos:segundos
